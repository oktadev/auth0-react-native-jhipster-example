...
describe('Album Screen Tests', () => {
  ...
  it('should allow you to create, update, and delete the Album entity', async () => {
    ...
    await setDateTimePickerValue('createdInput', '2022-08-31T22:35:00-06:00', 'ISO8601');
    // save
    ...
    jestExpect(Date.parse(createdCreateAttributes.label)).toEqual(Date.parse('2022-08-31T22:35:00-06:00'));
    ...
    // created
    await scrollTo('createdInput', 'albumEditScrollView');
    await setDateTimePickerValue('createdInput', '2022-08-31T22:30:00-06:00', 'ISO8601');
    // save
    await scrollTo('submitButton', 'albumEditScrollView');
    await waitThenTapButton('submitButton');
    ...
    jestExpect(Date.parse(createdUpdateAttributes.label)).toEqual(Date.parse('2022-08-31T22:30:00-06:00'));
